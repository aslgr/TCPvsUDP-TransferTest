...
def receive_file_from_server(filename, s):     
        
    log_file = './Logs_TCP/logsTCP.txt'
    ...
    origem = f'../server_TCP/Arquivos_server_TCP/{ARCHIVE_NAME}'
...
if __name__ == '__main__':
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        filename = f'./Arquivos_client_TCP/{ARCHIVE_NAME}'
        receive_file_from_server(filename, s)